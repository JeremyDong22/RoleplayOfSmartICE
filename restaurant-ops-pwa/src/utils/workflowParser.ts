// ⚠️ DEPRECATED - 已弃用 ⚠️
// 此文件中的硬编码任务数据已经不再使用
// 所有任务数据现在都从 Supabase 数据库动态加载
// 保留此文件仅为向后兼容性
// 
// 数据库表：
// - roleplay_tasks: 任务定义
// - roleplay_workflow_periods: 时段定义
// - roleplay_task_records: 任务提交记录
//
...
export interface TaskTemplate {
  ...
  manualClosing?: boolean  // 新增：标识是否为手动闭店任务
  samples?: {
    samples: Array<{
      index: number
      text: string
  ...
  } | null  // 新的samples结构，包含分组的文本、图片和checklist
}
