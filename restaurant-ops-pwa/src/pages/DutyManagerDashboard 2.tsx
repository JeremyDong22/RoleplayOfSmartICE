// 值班经理工作台页面
// Updated: Added Current Task container with TaskCountdown component for duty manager tasks
...
import { getCurrentPeriodFromDatabase } from '../services/businessCycleService'
        ...
        <Grid container sx={{ height: '100%' }}>
          <Grid size={{ xs: 12, md: 8 }}>
            <Box sx={{ height: '100%', p: 2, overflow: 'auto' }}>
              {/* Current Task Container using TaskCountdown */}
              {currentPeriod && (
                <TaskCountdown
                  ...
                  onComment={(noticeId, comment) => {
                    // Add notice comment to state
                    setState(prev => ({
                      ...prev,
                      noticeComments: [
                        ...prev.noticeComments,
